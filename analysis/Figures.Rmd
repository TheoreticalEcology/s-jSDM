...
par(mfrow = c(2,2), mar = c(2, 3, 0.2, 2))
#turn_over = abind::abind(turn_over_results, along = -1L)
for(i in 1:length(turn_over_list)){
matplot(t(turn_over_list[[i]]), type = "o", pch = 18, lty = 1, col = 1:6, axes = FALSE, ylim = c(0,1))
...
pdf(file = "./figures/Fig_S5_losses.pdf", width = 9, height = 4)
par(mfrow = c(2,2), mar = c(2, 3, 0.2, 2), oma = c(2,2,2,2))
nom = c("A", "B", "C", "D")
