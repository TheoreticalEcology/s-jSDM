...
if(!exists("gpuSparse")) gpuSparse = readRDS(file = "./results/sparse_gpu_dmvp3.RDS")
...
mean_conf(sites,hmsc_beh$result_corr_acc, col = cols[5])#, convergence = hmsc_beh, hmscObject = TRUE, indices = ind,  col = cols[5])
