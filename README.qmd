...
We also support other response families:
Count data:
```{r,eval=FALSE}
...
Let's do an ANOVA to partition the three components (abiotic, biotic, and spatial):
...
We can also visualize the individual contributions to species and site $$R^2$$:
