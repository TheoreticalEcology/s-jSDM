...
1) Using Moran's eigenvector map predictors
...
Regularization is an important technique for creating powerful predictive models
...
model = sjSDM(Y, env = linear(X, ~X1+X2), spatial = linear(XYcoords, ~0+XX:YY, lambda = 0.4))
summary(model)
```
