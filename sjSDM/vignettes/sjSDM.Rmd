...
output: 
  rmarkdown::html_vignette:
    toc: true
vignette: >
  %\VignetteIndexEntry{sjSDM: a scalable joint Species Distribution Model}
...
# Further analyses
## Anova
Analysis of variance for the two/three different components (environment, biotic associations, and space (optional)). sjSDM supports cross-validation in the anova to correct for the complexity of the model, which is somehow difficult to estimate:
```{r,eval=FALSE}
