...
The sjSDM package is an R package for estimating so-called joint species distribution models. Statistically, those are GLMMs with a multivariate response and a covariance term that models correlations between the different output dimensions (in the case of an SDM: species). 
...
dependencies should be installed as above:
...
ANOVA can be used to partition the three model components (abiotic, biotic, and spatial):
