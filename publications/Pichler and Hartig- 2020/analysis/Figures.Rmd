...
for(i in (as.character(unique(number)))){
  ...
  mean_conf(X, hmsc_result_env[as.character(number) == i & setup$env == e, ], col = cols[5], pch = 4)
    ...
    legend("bottomright", legend = c( "G-sjSDM", "GLLVM", "BayesComm", "HMSC"), col = cols, bty="n", lty = 1,  seg.len = 0.5, lwd = 2, xpd = NA, cex = 1.0, x.intersp = 1.0, pch = c( 17, 19, 15, 4))
}
...
for(i in (as.character(unique(number)))){
  ...
  mean_conf(X, hmsc_result_rmse[as.character(number) == i & setup$env == e, ], col = cols[5], pch = 4)
    ...
    legend("topright", legend = c("G-sjSDM", "GLLVM", "BayesComm", "HMSC"), col = cols, bty="n", lty = 1,  seg.len = 0.5, lwd = 2, xpd = NA, cex = 1.0, x.intersp = 1.0, pch = c( 17, 19, 15, 4))
...
pdf(file = "./figures/Fig_S3.pdf", width = 9, height = 4.3)
...
mean_conf(sites,bc_beh$result_corr_acc, pch = 15)
mean_conf(sites,hmsc_beh$result_corr_acc,pch = 4)

legend("topleft", legend = c("G-sjSDM", "GLLVM", "BayesComm", "HMSC"), col = cols, bty="n", lty = 1,  seg.len = 0.5, lwd = 2, xpd = NA, cex = 1.0, x.intersp = 1.0, pch = c( 17, 19, 15, 4))
