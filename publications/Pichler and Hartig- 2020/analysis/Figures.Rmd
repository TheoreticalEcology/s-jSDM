...
```{r}
svg(file = paste0("./figures/Fig_S2",".svg"), width = 9, height = 2.7)
...
svg(file = paste0("./figures/Fig_S4",".svg"), width = 9, height = 4.9)
...
svg(file = paste0("./figures/Fig_S5",".svg"), width = 9, height = 9)
par(mfrow = c(4,3), mgp = c(2.1,0.6,0), mar = c(0.6, 1.3, 0.3,0.7), oma = c(2.6,3.0,2.2,0)+0.3)
number = setup$species
spar = 0.5
e = 5L
...
```{r}
svg(file = paste0("./figures/Fig_S5",".svg"), width = 9, height = 4.3)
cols = RColorBrewer::brewer.pal(5, "Set2")
xx = 1:25
...
svg(file = paste0("./figures/Fig_S6",".svg"), width = 9, height = 4.9)
