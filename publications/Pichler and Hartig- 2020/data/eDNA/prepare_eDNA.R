...
# Code was taken and changed from https://github.com/tobiasgf/man_vs_machine/ 
...
read_otuk <- c(
  "data/eDNA/ds_survey_full.txt"              ,
  "data/eDNA/ds_survey_agaricomycetes.txt"    ,
  "data/eDNA/ds_survey_agaricales.txt"        ,
  "data/eDNA/ds_soilsurvey_full.txt"          ,
  "data/eDNA/ds_soilsurvey_agaricomycetes.txt",
  "data/eDNA/ds_soilsurvey_agaricales.txt"    ,
  "data/eDNA/ds_dna_full.txt"                 ,
  "data/eDNA/ds_dna_agaricomycetes.txt"       ,
  "data/eDNA/ds_dna_agaricales.txt" 
)
com_dis_ds <- list() # 
ttab_ds <- list()
